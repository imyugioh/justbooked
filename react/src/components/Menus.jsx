...
export default class Menus extends React.Component {
	...
	menuContent() {
		...
		_.map(this.props.menus, (item, idx) => {
			...
			const kname = `col-12 col-md-6 restaurant-grid-item phone-item menu_${item.id}`;
			items.push(
				<div key={idx} id={`restaurant_${idx}`} className={kname}>
					<a
						href={item.chef_page}
						className={classnames('restaurant', this.state.highlightedItemId === idx && 'highlighted')}
					>
						<figure>
							<div className="restaurant-thumb">
								...
								<img
									...
									height="220"
								/>
								<img src={item.chef.logo_url} alt={item.chef.name} className="chef-img" />
							</div>
							<figcaption>
								<h5 className="restaurant-title">
									<span className="chef-name">{item.chef.name}</span> - {item.name}
								</h5>
									...
									<div className="row align-items-center restaurant-reviews">
										<div className="col-6 text-nowrap">
											<span
												...
												readOnly="readonly"
												style={{ width: 91, display: 'inline-block', padding: 0 }}
											>
										...
										<div className="col-6 text-right">
											<div className="restaurant-distance restaurant-text">{`${item.distance} away`}</div>
										</div>
									</div>}
  ...
  e.stopPropagation(); this.handleMapIt(idx, item.longitude, item.latitude)}}>map it</span>
			...
			<div className="row">
				<div className="col-12 col-md-6 restaurant-grid-item">
					<a className="restaurant black">
						<figure>
							<div className="restaurant-thumb">
								<button type="button" className="restaurant-favorite js-fav-toggle">
									<span>Save</span>
								</button>
								<img
							...
							<figcaption>
								<h5 className="restaurant-title">Portuguese chicken and potatoes</h5>
								...
								<div className="row align-items-center restaurant-reviews">
									...
									<div className="col-6 text-right">
										<div className="restaurant-distance restaurant-text">29.5 km away map it</div>
									</div>
								</div>
						...
						<figure>
							...
							<figcaption>
								...
								<div className="row align-items-center restaurant-reviews">
									...
									<div className="col-6 text-right">
										<div className="restaurant-distance restaurant-text">0.0 km away>map it</div>
									</div>
								</div>
				...
				<div className="col-12 col-md-6 restaurant-grid-item">
					<a className="restaurant black">
						<figure>
							<div className="restaurant-thumb">
								<button type="button" className="restaurant-favorite js-fav-toggle is-active">
									<span>Save</span>
								</button>
								<img
	...
	render() {
		...
		return (
			<div className="container-fluid menus-view">
				<div className="venues js-venues">
					{content}
					{mapContent}
				</div>
			</div>
