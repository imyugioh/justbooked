...
export default class Chefs extends React.Component {
  ...
  render() {
    const { chefs, api_fetched } = this.props;

    return (
      <div className="container-fluid chefs-view show">
        {chefs.length === 0 && api_fetched && this.noDataContent()}
        <div className="row">
          <div className="col-md-10 offset-md-1 col-sm-12">
            {chefs.map(chef => (
              <a
                key={chef.id}
                href={chef.my_listings_path}
                  ...
                  <div className="media">
                    ...
                    <div className="media-body hidden-md-down">
                      ...
                      <div className="hidden-md-down">
                        <p className="mt-0 mb-0 bold">
                          minimum $
                          {parseFloat(chef.pre_order_min_order_amount).toFixed(
                            2
                          )}{" "}
                          order
                        </p>
