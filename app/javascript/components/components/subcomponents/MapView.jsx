		...
		{state => {
			return (
				<div className={classnames('defaultStyle', state)}>
					<a className="venue-image" href="#" style={{ backgroundImage: `url(${item.url})` }} />
					<div className="venue-footer">
						<div className="venue-name">
							{item.title}
						</div>
						<div className="venue-rating">
							<ReactStars count={5} size={22} defaultValue={item.likes} color2={'#ff0000'} edit={false} />
			...
			<OutsideClickHandler onOutsideClick={this.hide}>
				<div className="marker" style={{ marginTop: '-50px' }}>
					<div
						...
						style={{ cursor: 'pointer', width: '70px', height: '30px' }}
					>
					...
					<ItemDetail in={isVisible || !!show} item={item} />
				</div>
			</OutsideClickHandler>
		);
	}
